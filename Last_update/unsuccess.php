...
<div class="header">
	...
	<link rel="stylesheet" href="./jscss/failPayment.css">
	
		<div class="block failPayment">
			<div class="content">
				<h2><div class="icon"></div>ПРОИЗОШЛА ОШИБКА</h2>
                <h3>При оплате возникли неполадки</h3>
                <div class="img"></div>
                <div class="under">
                    <p>Во время процесса оплаты заказа #227434 (платеж #1258957591) произошла ошибка.<br>Обратитесь в поддержку и укажите номер заказа и платежа</p>
                    <div class="buttons">
                        <a name="shop" href="/shop"><button><div class="icon"></div>В магазин</button></a>
                        <a name="help" href="http://vk.com/iwuds"><button>В поддержку<div class="icon"></div></button></a>
                    </div>
                </div>
			</div>
			<div class="footer">
...
<script src="./jscss/sockets.js" type="text/javascript"></script></body></html>